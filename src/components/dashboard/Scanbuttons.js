...
function Scanbuttons() {
    return (
        <>
            ...
            <Typography style={{ textAlign: 'start', fontSize: '28px', marginTop: '20px' }}>
                About Us
            </Typography>
            <Typography style={{ textAlign: 'start', fontSize: '18px', marginTop: '10px' }}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque vehicula venenatis mi. Pellentesque lectus est,
            </Typography>
            <Typography style={{ textAlign: 'start', fontSize: '28px', margin: '20px 0px' }}>
                Scans
            </Typography>
